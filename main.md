...
| **Karen Guard** | Evaluator/Critic. Reads the CV, job description, and actual repository code. Produces a skeptical technical evaluation with a fit score. | Gemini CLI (`agy`) inside container |
