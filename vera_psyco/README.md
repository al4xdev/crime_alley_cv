...
Vera operates as a subagent, invoked **once before the optimization loop** and only when needed. She is **optional**: if a usable `who_are_u.md` already exists, the orchestrator reuses it and skips Vera.
